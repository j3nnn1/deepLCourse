...
from sklearn.linear_model import LogisticRegression
# from sklearn.linear_model.logistic import _logistic_loss #@TODO buscar como hacer con esta version
# The sklearn.linear_model.logistic module is  deprecated in version 0.22 and will be removed in version 0.24. The
# corresponding classes / functions should instead be imported from sklearn.linear_model. Anything that cannot be
# imported from sklearn.linear_model is now part of the private API. warnings.warn(message, FutureWarning)
